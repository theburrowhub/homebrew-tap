...
class CherryGo < Formula
  ...
  on_macos do
    on_arm do
      ...
      def install
        bin.install "cherry-go-macos-arm64" => "cherry-go"
    ...
    on_intel do
      ...
      def install
        bin.install "cherry-go-macos-amd64" => "cherry-go"
        generate_completions_from_executable(bin/"cherry-go", "completion")
      end
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      def install
        bin.install "cherry-go-linux-arm64" => "cherry-go"
        generate_completions_from_executable(bin/"cherry-go", "completion")
      end
    end
    ...
    on_intel do
      ...
      def install
        bin.install "cherry-go-linux-amd64" => "cherry-go"
        generate_completions_from_executable(bin/"cherry-go", "completion")
      end
    end
  end
